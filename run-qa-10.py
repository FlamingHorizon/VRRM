...
ent_list = {'1':'office', '2':'school', '3':'kitchen', '4':'park', '5':'bedroom', '6':'cinema',
            '7':'mary', '8':'fred', '9':'bill', '10':'julie',
           }
        ...
        for story_id in range(n_samples):
            ...
            for sim_round in range(params['story_sims_per_epoch']):
                ...
                for q_idx in range(len(retrieve_probs[0])):                    
                    ...
                    retrieved_relation_list.append(search_result)
                ...
                for q_idx in range(len(retrieve_probs[0])):
                    ...
                    if retrieved_relation_list[q_idx] == -1:
                        ans_pred = 'no'
                    elif retrieved_relation_list[q_idx] == 1:
                        ans_pred = 'yes'
                    else:
                        ans_pred = 'maybe'
...
if __name__ == '__main__':
    train_file_names = ['../en/qa10_indefinite-knowledge_train.txt']
    test_file_names = ['../en/qa10_indefinite-knowledge_test.txt']
