...
def DRL_Reasoner(params):
    ...
    arg12_list = [Reshape((1, vocab_size_entity * 1, 1))(merge([Slice(i)(arg1_T), Slice(i)(arg2_T)], mode='dot', dot_axes=(2,1))) for i in range(max_q_num)] 
    arg12 = arg12_list[0]
    ...
    def modifyEnv(self, commend):
        if commend:
            if commend[1] == 1:
                ...
                self.tupleList.append(commend)
            elif commend[1] == 3 or commend[1] == 4:
