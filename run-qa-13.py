...
def DRL_Reasoner(params):
    ...
    rmsp = RMSprop(clipnorm=2., lr=0.01)
    sgd = SGD(clipnorm=2.)
...
ent_list = {'1':'office', '2':'hallway', '3':'kitchen', '4':'garden', '5':'bedroom', '6':'bathroom',
            '7':'mary', '8':'john', '9':'daniel', '10':'sandra', '11': 'they'}
...
if __name__ == '__main__':
    train_file_names = ['../en/qa13_compound-coreference_train.txt']
    test_file_names = ['../en/qa13_compound-coreference_test.txt']
