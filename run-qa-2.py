...
def parse_stories(lines, vocab, inv_vocab, cut):
    ...
    for line in lines:
        ...
        if q_flag == 1 and line_count != 0:
            ...
            if cut == 0 or (cut == 1 and len(substory) <= 20):
                substory = substory[-20:]
        ...
        if commend:
            ...
            if commend[1] == 1: # not-relative
                ...
                if commend in self.tupleList:
                    ...
                    self.tupleList.append(commend) # a people has a belonging
                    move_to = None
                    for a, r, b in self.tupleList:
                ...
                if len(temp_tupleList) == len(self.tupleList):
                    self.tupleList = []
                else:
...
if __name__ == '__main__':
    train_file_names = ['../en/qa2_two-supporting-facts_train.txt']
    test_file_names = ['../en/qa2_two-supporting-facts_test.txt']
