        ...
        for story_id in range(n_samples):
            ...
            for sim_round in range(params['story_sims_per_epoch']):
                ...
                for q_idx in range(len(retrieve_probs[0])):                    
                    ...
                    count_result = working_memory.retrieveArgCount(arg1_retr_int)                  
                    
                    retrieved_relation_list.append(count_result)
                ...
                for q_idx in range(len(retrieve_probs[0])):
                    ...
                    if retrieved_relation_list[q_idx] < 4:
                        ans_pred = ans_word_list[retrieved_relation_list[q_idx]]
                    else:
                        ans_pred = 'njynhnjynh'
...
def set_hyper_params():
    ...
    params['test_set_size'] = 100
    return params



if __name__ == '__main__':
    train_file_names = ['../en/qa7_counting_train.txt']
    test_file_names = ['../en/qa7_counting_test.txt']
